...
// Program to draw a coloured hut
...
int main(){
 int gd = DETECT,gm;
    ...
    /* Draw Hut */
    setcolor(WHITE);
    rectangle(0,180,100,300);
    rectangle(100,180,270,300);
    rectangle(30,250,70,300);

    line(50,100,0,180);
    line(50,100,100,180);
    line(50,100,220,100);
    line(220,100,270,180);
   ...
   outtextxy(298,150,"Vipul");
   outtextxy(298,160,"Gupta");
