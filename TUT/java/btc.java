...
public class btc extends Applet
{
...
return String.valueOf(s);
    ...
    public void init()
    {
     ...
     t6.setText ("");
     t7.setText ("");
     bCalci = new Button("Calculate");
     bCalci.setBounds(100,150,100,30);
     bCalci.setVisible(true);
     add(bCalci);
     bCalci.addActionListener(new ActionListener(){
